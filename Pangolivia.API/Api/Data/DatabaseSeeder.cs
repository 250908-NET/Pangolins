            ...
            if (!context.Questions.Any())
            {
                ...
                var questions = new List<QuestionModel>
                {
                    ...
                    new QuestionModel
                    {
                        QuizId = generalQuiz.Id,
                        QuestionText =
                            "What is the primary goal of the player at the start of Stardew Valley?",
                        CorrectAnswer =
                            "Restore and manage a neglected farm inherited from their grandfather",
                    ...
                    new QuestionModel
                    {
                        ...
                        Answer2 = "Nucleus",
                        Answer3 = "Ribosome",
                        Answer4 = "Golgi apparatus",
                    },
                    new QuestionModel
                    {
                        QuizId = scienceQuiz.Id,
                        QuestionText = "Which gas do plants primarily take in for photosynthesis?",
                    ...
                    {
                        QuizId = scienceQuiz.Id,
                        QuestionText = "What is the approximate speed of light in vacuum (m/s)?",
                        CorrectAnswer = "299,792,458 m/s",
                        Answer2 = "150,000,000 m/s",
                        Answer3 = "3,000,000 m/s",
                        Answer4 = "1,080,000,000 m/s",
                    },
                    new QuestionModel
                    {
                        QuizId = scienceQuiz.Id,
                    ...
                    {
                        QuizId = historyQuiz.Id,
                        QuestionText = "Which empire was founded by Genghis Khan?",
                        CorrectAnswer = "Mongol Empire",
                        Answer2 = "Ottoman Empire",
                        Answer3 = "Roman Empire",
                        Answer4 = "Persian Empire",
                    },
                    new QuestionModel
                    {
                        QuizId = historyQuiz.Id,
