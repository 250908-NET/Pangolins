...
namespace Pangolivia.API.Data
{
    public static class DbSeeder
    {
        public static void Seed(PangoliviaDbContext context)
        {
            ...
            {
                new UserModel { AuthUuid = Guid.NewGuid().ToString(), Username = "Alice" },
                new UserModel { AuthUuid = Guid.NewGuid().ToString(), Username = "Bob" },
                new UserModel { AuthUuid = Guid.NewGuid().ToString(), Username = "Charlie" },
                new UserModel { AuthUuid = Guid.NewGuid().ToString(), Username = "Diana" }
            };
